...
class TestNotionClient:
    ...
    def test_notion_client_initialization_with_api_key(self):
        ...
        with patch('services.notion_service.notion_client.Client') as mock_client:
    ...
    def test_notion_client_initialization_from_config(self):
        ...
        with patch('services.notion_service.notion_client.config') as mock_config:
    ...
    def test_create_database_entry(self):
        ...
        with patch('services.notion_service.notion_client.Client') as mock_client_class:
            mock_client = Mock()
    ...
    def test_create_location_entry_delegates_to_location_handler(self):
        ...
        with patch('services.notion_service.notion_client.Client'):
            with patch('services.notion_service.location_handler.LocationHandler') as mock_handler_class:
                mock_handler = Mock()
    ...
    def test_get_pending_urls_delegates_to_url_processor(self):
        ...
        with patch('services.notion_service.notion_client.Client'):
            with patch('services.notion_service.url_processor.URLProcessor') as mock_processor_class:
                mock_processor = Mock()
